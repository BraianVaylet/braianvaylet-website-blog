...
const MDXComponents = {
  a: AlterLink,
  hr: Divider,
  h1: (props: HeadingProps) => <Heading as="h1" my={8} size="3xl" {...props} />,
  h2: (props: HeadingProps) => <Heading as="h2" my={4} size="2xl" {...props} />,
  h3: (props: HeadingProps) => <Heading as="h3" my={4} size="xl" {...props} />,
  h4: (props: HeadingProps) => <Heading as="h4" my={2} size="lg" {...props} />,
  h5: (props: HeadingProps) => <Heading as="h5" my={2} size="md" {...props} />,
  h6: (props: HeadingProps) => <Heading as="h6" my={2} size="sm" {...props} />,
